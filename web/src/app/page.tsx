...
export default function Home() {
  ...
  return (
    <>
      <header className="relative z-10 flex w-full items-center justify-between border-b border-b-[#9265E2] px-8 py-2">
      ...
      <main className="h-[calc(100vh_-_53px)] w-screen">
        <Image
          src="/Group 15.png"
          alt=""
          className="left-[auto!important] right-[0%!important] z-0 h-[75%!important] w-[45%!important]"
          fill
        />
      </main>
    </>
